...
namespace OData.Infrastructure.Sql.Entities;
...
public class EventStoreRecord
{
    ...
    public static EventStoreRecord CreateRecord(Guid recordId, string serializedData, int version,
        DateTimeOffset createdAt,
        string domainEventName, string aggregateName, string aggregateRootId)
    {
        return new EventStoreRecord(recordId, serializedData, version, createdAt, domainEventName, aggregateName,
            aggregateRootId);
    }
}